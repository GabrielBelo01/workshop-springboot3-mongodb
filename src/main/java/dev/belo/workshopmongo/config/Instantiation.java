package dev.belo.workshopmongo.config;

import dev.belo.workshopmongo.domain.Post;
import dev.belo.workshopmongo.domain.User;
import dev.belo.workshopmongo.dto.AuthorDTO;
import dev.belo.workshopmongo.dto.CommentDTO;
import dev.belo.workshopmongo.repository.PostRepository;
import dev.belo.workshopmongo.repository.UserRepository;
...
public class Instantiation implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        CommentDTO c4 = new CommentDTO("Ninguem liga!",sdf.parse("24/03/2018"), new AuthorDTO(bob));
